...
import static com.app.projectfinal_master.utils.Constant.UPDATE_ADDRESS;
...
public class UpdateAddressActivity extends AppCompatActivity {
    ...
    private void setViewButton() {
        String nickname = edtAddress.getText().toString().trim();
        if (!nickname.isEmpty() && !edtAddress.getText().toString().equals(user.getAddress())) {
    ...
    private void setOnClickButtonAccept() {
        btnAccept.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!CheckStateNetwork.isNetworkAvailable(UpdateAddressActivity.this)) return;
                String username = edtAddress.getText().toString();
                updateUsername(UpdateAddressActivity.this, user.getIdUser(), username);
//                finish();
            }
        });
    }
