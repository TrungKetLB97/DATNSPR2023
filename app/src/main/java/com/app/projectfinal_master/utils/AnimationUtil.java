...
public class AnimationUtil {
    ...
    public static void translateAnimation(final ImageView viewAnimation, @NonNull final View startView, View endView,
        ...
        ScaleAnimation startScaleAnimation = new ScaleAnimation(1f, 1.5f, 1f, 1.5f, startViewWidthCenter, startViewHeightCenter);
        ...
        ScaleAnimation translateScaleAnimation = new ScaleAnimation(1f, 0f, 1f, 0f, toX, toY);
